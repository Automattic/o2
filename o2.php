	...
	public function register_plugin_scripts() {
		...
		$o2_options = array(
			...
			'strings' => array(
				...
				'filenameNotUploadedWithType'          => __( '%1$s was not uploaded (%2$s files are not allowed).' ),
				'filenameNotUploadedNoType'            => __( '%1$s was not uploaded (unrecognized file type).' ),
				'fileTypeNotSupported'                 => __( 'Sorry, %1$s files are not allowed.' ),
				'unrecognizedFileType'                 => __( 'Sorry, file not uploaded (unrecognized file type).' ),
